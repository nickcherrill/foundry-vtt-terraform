...
variable "az_devops_pat" {
	type = string
	description = "Grant the admin of the project Build Admin role on ADO. Add the role to the Agent Pool, then generate a Personal Access Token (PAT) for Azure DevOps. Create it at https://dev.azure.com/[Organization]/_usersSettings/tokens with permission Agent Pools > Read & manage"
	default = "null"
}
